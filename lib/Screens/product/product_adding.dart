...
class _ProductAddPageState extends State<ProductAddPage> {
  ...
  Future<void> _pickImageWithCropCompress(
    ImageSource source,
    bool isProductImage, // This parameter is not used in the provided snippet
  ) async {
    try {
      ...
      if (pickedImage != null) {
        ...
        if (extension != 'jpg' && extension != 'jpeg' && extension != 'png') {
          // You'll need to ensure 'context' is available here,
          // or pass it to this function if it's a standalone helper.
          // Assuming _showSnackBar uses the page's context implicitly or explicitly.
          _showSnackBar(
        ...
        showDialog(
          context: context, // Ensure 'context' is accessible here
        ...
        try {
          ...
          setState(() {
            // Ensure 'setState' is accessible for updating _imageFile
